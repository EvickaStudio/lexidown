                                                  ...
                                                  lxb_html_token_t *token)
{
    ...
    if (token->tag_id == LXB_TAG_MENU
        && lxb_html_tree_node_is_menuitem(lxb_html_tree_current_node(tree)))
    {
                                        ...
                                        lxb_html_token_t *token)
{
    ...
    if (lxb_html_tree_node_is_menuitem(lxb_html_tree_current_node(tree))) {
        lxb_html_tree_open_elements_pop(tree);
    }
                                                   ...
                                                   lxb_html_token_t *token)
{
    ...
    if (lxb_html_tree_tag_is_menuitem(token->tag_id)
        && lxb_html_tree_node_is_menuitem(lxb_html_tree_current_node(tree)))
    {
        lxb_html_tree_open_elements_pop(tree);
    }
